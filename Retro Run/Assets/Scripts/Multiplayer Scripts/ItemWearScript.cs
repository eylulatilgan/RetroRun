...
public class ItemWearScript : MonoBehaviour {
	...
	{
        PlayFabGameBridge.Instance.currentSkin = PlayFabGameBridge.Instance.boughtSkins[MarketManagerScript.selectedSkin.ItemId];
        UpdatePlayerData(PlayFabGameBridge.Instance.currentSkin);
    ...
    {
        PlayFabGameBridge.Instance.currentMissile = PlayFabGameBridge.Instance.boughtMissiles[MarketManagerScript.selectedMissile.ItemId];
        UpdatePlayerData(PlayFabGameBridge.Instance.currentMissile);
